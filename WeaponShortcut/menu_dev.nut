...
void function SetupDefaultDevCommandsMP()
{
	...
	if(GetCurrentPlaylistName() == "fs_dm" || GetCurrentPlaylistName() == "fs_1v1")
	{
		...
		SetupDevCommand( "TDM: Give Primary Volt", "tgive p mp_weapon_volt_smg optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 energy_mag_l3; saveguns")
		SetupDevCommand( "TDM: Give Secondary Volt", "tgive s mp_weapon_volt_smg optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 energy_mag_l3; saveguns")
		SetupDevCommand( "TDM: Give All Volt", "tgive p mp_weapon_volt_smg optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 energy_mag_l3; tgive s mp_weapon_volt_smg optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 energy_mag_l3; saveguns")
		SetupDevCommand( "1v1 Weapons shortcut byKaaariyaaa", "empty" )
		//RunCodeDevCommandByAlias("tgive s mp_weapon_volt_smg optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 energy_mag_l3; saveguns")
	}
	...
	if(GetCheatsState()){
		...
		SetupDevCommand( "Melee: Equip Bolo Sword", "script thread SetupHeirloomBoloSword()" )
...
void function SetupTDMPrimaryWeapsons()
{
	...
	//SMGs
	SetupDevCommand( "R-99 SMG", "tgive p mp_weapon_r97 optic_cq_hcog_classic stock_tactical_l3 laser_sight_l3 bullets_mag_l3" )
	SetupDevCommand( "Alternator SMG", "tgive p mp_weapon_alternator_smg optic_cq_hcog_bruiser stock_tactical_l3 laser_sight_l3 bullets_mag_l3" )
	SetupDevCommand( "Prowler Burst SMG", "tgive p mp_weapon_pdw laser_sight_l3 optic_cq_hcog_classic stock_tactical_l3 highcal_mag_l3" )
	SetupDevCommand( "Volt SMG", "tgive p mp_weapon_volt_smg laser_sight_l3 stock_tactical_l3 energy_mag_l3" )
	SetupDevCommand( "CAR SMG", "tgive p mp_weapon_car optic_cq_hcog_classic stock_tactical_l3 bullets_mag_l3" )
	//Marksman Weapons
	...
	//Pistols
	SetupDevCommand( "RE-45", "tgive p mp_weapon_autopistol optic_cq_hcog_classic laser_sight_l3 bullets_mag_l3" )
	SetupDevCommand( "P2020", "tgive p mp_weapon_semipistol optic_cq_hcog_classic laser_sight_l3 bullets_mag_l3 hopup_unshielded_dmg" )
	SetupDevCommand( "Wingman", "tgive p mp_weapon_wingman optic_cq_hcog_classic sniper_mag_l3" )
	//Shotguns
	SetupDevCommand( "EVA-8", "tgive p mp_weapon_shotgun optic_cq_threat hopup_double_tap" )
...
void function SetupTDMSecondaryWeapsons()
{
	...
	//SMGs
	SetupDevCommand( "R-99 SMG", "tgive s mp_weapon_r97 optic_cq_hcog_classic stock_tactical_l3 laser_sight_l3 bullets_mag_l3" )
	SetupDevCommand( "Alternator SMG", "tgive s mp_weapon_alternator_smg optic_cq_hcog_bruiser stock_tactical_l3 laser_sight_l3 bullets_mag_l3" )
	SetupDevCommand( "Prowler Burst SMG", "tgive s mp_weapon_pdw optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 highcal_mag_l3" )
	SetupDevCommand( "Volt SMG", "tgive s mp_weapon_volt_smg laser_sight_l3 stock_tactical_l3 energy_mag_l3" )
	SetupDevCommand( "CAR SMG", "tgive s mp_weapon_car optic_cq_hcog_classic stock_tactical_l3 bullets_mag_l3" )
	//Marksman Weapons
	...
	//Pistols
	SetupDevCommand( "RE-45", "tgive s mp_weapon_autopistol optic_cq_hcog_classic laser_sight_l3 bullets_mag_l3" )
	SetupDevCommand( "P2020", "tgive s mp_weapon_semipistol optic_cq_hcog_classic laser_sight_l3 bullets_mag_l3 hopup_unshielded_dmg" )
	SetupDevCommand( "Wingman", "tgive s mp_weapon_wingman optic_cq_hcog_classic sniper_mag_l3" )
	//Shotguns
	SetupDevCommand( "EVA-8", "tgive s mp_weapon_shotgun optic_cq_threat hopup_double_tap" )
...
void function GivePrimaryVolt( var button )
{
	string cmd = "tgive p mp_weapon_volt_smg optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 energy_mag_l3; saveguns"
	//RunCodeDevCommandByAlias()
	ClientCommand( cmd )
}

void function GiveSecondaryVolt( var button )
{
	string cmd = "tgive s mp_weapon_volt_smg optic_cq_hcog_classic laser_sight_l3 stock_tactical_l3 energy_mag_l3; saveguns"
	//RunCodeDevCommandByAlias()
	ClientCommand( cmd )
}
